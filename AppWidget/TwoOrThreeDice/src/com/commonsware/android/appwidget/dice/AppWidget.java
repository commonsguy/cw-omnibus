...
public class AppWidget extends AppWidgetProvider
{
			...
			int appWidgetId)
	{
		...
		{
			int category = mgr.getAppWidgetOptions(appWidgetId).getInt(
					AppWidgetManager.OPTION_APPWIDGET_HOST_CATEGORY, -1);

			layout = (category == AppWidgetProviderInfo.WIDGET_CATEGORY_KEYGUARD) ? R.layout.lockscreen
					: R.layout.widget;
		}
		...
		PendingIntent pi = PendingIntent.getBroadcast(ctxt, appWidgetId, i,
