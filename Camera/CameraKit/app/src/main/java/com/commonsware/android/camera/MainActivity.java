...
public class MainActivity extends AbstractPermissionActivity {
  ...
  protected void onActivityResult(int requestCode, int resultCode,
    ...
    else if (requestCode==RESULT_VIDEO_RECORDED && resultCode==RESULT_OK) {
      Toast.makeText(this, R.string.msg_vid_recorded, Toast.LENGTH_LONG).show();
    }
    else {
  ...
  public void recordVideo(View v) {
    CameraActivity.recordVideo(this, RESULT_VIDEO_RECORDED);
  }
