...
class OldContactsAdapterBridge extends ContactsAdapterBridge
{
	...
	ListAdapter buildPhonesAdapter(Activity a)
	{
		...
		Cursor c = a.managedQuery(Contacts.Phones.CONTENT_URI, PROJECTION,
	...
	ListAdapter buildEmailAdapter(Activity a)
	{
		...
		return (new SimpleCursorAdapter(a, android.R.layout.simple_list_item_2,
				c, new String[] { Contacts.PeopleColumns.NAME,
						Contacts.ContactMethods.DATA }, new int[] {
