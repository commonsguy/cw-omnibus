...
public class MainActivity extends FragmentActivity implements
  ...
  private class VideoAdapter extends ChoiceCapableAdapter<RowController> {
    Cursor videos=null;
    ...
    public RowController onCreateViewHolder(ViewGroup parent,
      ...
      return(new RowController(getLayoutInflater()
        .inflate(R.layout.row, parent, false), this));
    }
    ...
    public void onBindViewHolder(RowController holder, int position) {
      ...
      holder.bindModel(videos, isChecked(position), position);
    }
