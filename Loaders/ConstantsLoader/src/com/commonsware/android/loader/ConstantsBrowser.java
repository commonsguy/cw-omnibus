		...
		LoaderManager.LoaderCallbacks<Cursor>
{
	 ...
	 * transactions while in this call, since it can happen after an activity's 
	 * state is saved. See FragmentManager.openTransaction() for further 
	 * discussion on this.
	 * 
	 * This function is guaranteed to be called prior to the release of the last 
	 * data that was supplied for this Loader. At this point you should remove 
	 * all use of the old data (since it will be released soon), but should not 
	 * do your own release of the data since its Loader owns it and will take 
	 * care of that. The Loader will take care of management of its data so you 
	 ...
	 * its data unavailable. The application should at this point remove any 
	 * references it has to the Loader's data.
	 */
