...
public class StringBufferActivity extends BaseActivity {
  StringBufferTask createTask(TextView msg, View v) {
    return(new StringBufferTask(msg, v));
  }
  
  class StringBufferTask extends BaseTask {
    StringBufferTask(TextView msg, View v) {
      super(msg, v);
    }
    
    protected String doTest() {
      StringBuffer result=new StringBuffer("This is a string");
